...
public class Signature
{
			...
			String privStr ) throws IOException
	{
		...
		try{
		   ...
		   // System.out.println("#jsonString : \n" + jsonString);
		    ...
		    String userSig = new String(Encoder.base64EncodeUrl(Arrays.copyOfRange(compressBytes,0,compressBytesLength)));
			...
			String publicKey ) throws DataFormatException
	{
		...
		byte [] compressBytes = Encoder.base64DecodeUrl(urlSig.getBytes(Charset.forName("UTF-8")));
