...
import com.qcloud.uri.Constant;
...
public class XingeApp 
{
	...
	public JSONObject pushSingleDevice(String deviceToken, Message message)
	{
		...
		return callRestful( Constant.URI_NOTIFICATION_PUSHSINGLEDEVICE, params);
	}
	...
	public JSONObject pushSingleAccount(int deviceType, String account, Message message)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHSINGLEACCOUNT, params);
	}
	...
	public JSONObject pushAccountList(int deviceType, List<String> accountList, Message message)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHACCOUNTLIST, params);
	}
	...
	public JSONObject pushAllDevice(int deviceType, Message message)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHALLDEVICE, params);
	}
	...
	public JSONObject pushTags(int deviceType, List<String> tagList, String tagOp, Message message)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHTAGS, params);
	}
	...
	public JSONObject createMultipush(Message message)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_CREATEMULTIPUSH, params);
	}
	...
	public JSONObject pushAccountListMultiple(int pushId, List<String> accountList)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHACCOUNTLISTMULTIPLE, params);
	}
	...
	public JSONObject pushDeviceListMultiple(int pushId, List<String> deviceList)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_PUSHDEVICELISTMULTIPLE, params);
	}
	...
	public JSONObject queryPushStatus(List<String> pushIdList)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYPUSHSTATUS, params);
	}
	...
	public JSONObject queryDeviceCount()
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYDEVICECOUNT, params);
	}
	...
	public JSONObject queryTags(int start, int limit)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYTAGS, params);
	}
	...
	public JSONObject queryTagTokenNum(String tag)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYTAGTOKENNUM, params);
	}
	...
	public JSONObject queryTokenTags(String deviceToken)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYTOKENTAGS, params);
	}
	...
	public JSONObject cancelTimingPush(String pushId)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_CANCELTIMINGPUSH, params);
	}
	...
	public JSONObject BatchSetTag(List<TagTokenPair> tagTokenPairs) 
	{
	    ...
	    List<List<String>> tag_token_list = new ArrayList<List<String>>();
	    ...
	    params.put("tag_token_list", new JSONArray(tag_token_list).toString());
	  	...
	  	return callRestful(Constant.URI_NOTIFICATION_BATCHSETTAG, params); 
	}
	...
	public JSONObject BatchDelTag(List<TagTokenPair> tagTokenPairs) 
	{
	    ...
	    params.put("tag_token_list", new JSONArray(tag_token_list).toString());
	  	...
	  	return callRestful(Constant.URI_NOTIFICATION_BATCHDELTAG, params); 
	}
	...
	public JSONObject queryInfoOfToken(String deviceToken)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYINFOOFTOKEN, params);
	}
	...
	public JSONObject queryTokensOfAccount(String account)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_QUERYTOKENSOFACCOUNT, params);
	}
	...
	public JSONObject deleteTokenOfAccount(String account, String deviceToken)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_DELETETOKENOFACCOUNT, params);
	}
	...
	public JSONObject deleteAllTokensOfAccount(String account)
	{
		...
		return callRestful(Constant.URI_NOTIFICATION_DELETEALLTOKENSOFACCOUNT, params);
	}
